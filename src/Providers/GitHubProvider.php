...
class GitHubProvider implements OAuthProvider
{
     ...
     * @param string|null $state CSRF state generated and stored by Authorization
    ...
    public function getAuthorizationUrl(
        ...
        if ($state === null || $state === '') {
            throw new InvalidArgumentException('OAuth state must be generated by Authorization');
        }
